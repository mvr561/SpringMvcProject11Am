...
<nav class="navbar navbar-expand-sm bg-secondary navbar-dark ">
	<!-- Brand -->
	<a class="navbar-brand " href="#"><img src="../resources/images/logo.png" width="40" height="35" /></a>
    ...
    <li class="nav-item">
      <a class="nav-link" href="#">Link 2</a>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu">
				<a class="dropdown-item" href="${url}/wst/register">Register </a>
        <a class="dropdown-item" href="${url}/wst/all">View All</a>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu">
				<a class="dropdown-item" href="${url}/item/register">Register </a> <a
					class="dropdown-item" href="${url}/item/all">View All</a> 
			</div></li>
