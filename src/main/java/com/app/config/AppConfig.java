...
public class AppConfig  implements WebMvcConfigurer{
	...
	public LocalSessionFactoryBean sfObj() {
		...
		sf.setAnnotatedClasses(ShipmentType.class,Uom.class,OrderMethod.class,WhUserType.class,User.class,Document.class,Item.class,Purchase.class); //Model class names
		return sf;
	}
